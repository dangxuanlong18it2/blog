...
@section('content')
  ...
  <div class="row">
    <div class="col-sm-9">
      ...
      <form id="form_draft_blog" action="{{URL::to('post_draft_blog')}}" method="post">
        @csrf
      @if(isset($new))

        @foreach($new as $key => $n)

        @if(isset($n->tf_draft_id))
          <input type="hidden" value="{{$n->tf_draft_id}}" name="draft_id">
        @endif

        @if(isset($n->tf_post_id))
          <input type="hidden" value="{{$n->tf_post_id}}" name="tf_post_id">
        @endif

        <input type="text" class="form-control" id="tieude" name="tf_post_title" value="@if(isset($n->tf_draft_title)) {{$n->tf_draft_title}} @elseif(isset($n->tf_post_title)) {{$n->tf_post_title}} @endif "><br>
        <table class="table" style="background: #FAFAFA">
          ...
          <tr>
            <td>
              <textarea class="form-control" name="tf_post_sapo">@if(isset($n->tf_draft_sapo)) {{$n->tf_draft_sapo}} @elseif(isset($n->tf_post_sapo)) {{$n->tf_post_sapo}} @endif</textarea>
            </td>
          </tr>
        </table>
        <textarea id="editor" name="tf_post_content">@if(isset($n->tf_draft_content)) {{$n->tf_draft_content}} @elseif(isset($n->tf_post_content)) {{$n->tf_post_content}} @endif</textarea><br>
          ...
          <tr>
            <td>
              <table class="table" style="background: #FAFAFA">
                ...
                <tr>
                  <td>
                    <input type="text" class="form-control" id="tieude" name="tf_post_titleseo" value="@if(isset($n->tf_draft_titleseo)) {{$n->tf_draft_titleseo}} @elseif(isset($n->tf_post_titleseo)) {{$n->tf_post_titleseo}} @endif">
                  </td>
                </tr>
              </table>
              <table class="table" style="background: #FAFAFA">
                ...
                <tr>
                  <td>
                    <input type="text" class="form-control" id="tieude" name="tf_post_url" value="@if(isset($n->tf_draft_url)) {{$n->tf_draft_url}} @elseif(isset($n->tf_post_url)) {{$n->tf_post_url}} @endif">
                  </td>
                </tr>
              </table>
              <table class="table" style="background: #FAFAFA">
                ...
                <tr>
                  <td>
                    <textarea class="form-control" name="tf_post_meta" >
                      @if(isset($n->tf_draft_meta)) {{$n->tf_draft_meta}} @elseif(isset($n->tf_post_meta)) {{$n->tf_post_meta}} @endif
                    </textarea>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td>
                    <div class="input-group mb-3">
                      <input type="text" class="form-control" placeholder="Example: Rank Math SEO" name="tf_post_key" value="@if(isset($n->tf_draft_key)) {{$n->tf_draft_key}} @elseif(isset($n->tf_post_key)) {{$n->tf_post_key}} @endif">
        ...
        @endforeach 
      @else
        <input type="text" class="form-control" id="tieude" name="tf_post_title" ><br>
        <table class="table" style="background: #FAFAFA">
          <tr>
            <th><label>Tóm tắt bài viết</label></th>
          </tr>
          <tr>
            <td>
              <textarea class="form-control" name="tf_post_sapo" ></textarea>
            </td>
          </tr>
        </table>
        <textarea id="editor" name="tf_post_content" ></textarea><br>
          ...
          <tr>
            <td>
              <table class="table" style="background: #FAFAFA">
                ...
                <tr>
                  <td>
                    <input type="text" class="form-control" id="tieude" name="tf_post_titleseo" >
                  </td>
                </tr>
              </table>
              <table class="table" style="background: #FAFAFA">
                ...
                <tr>
                  <td>
                    <input type="text" class="form-control" id="tieude" name="tf_post_url" >
                  </td>
                </tr>
              </table>
              <table class="table" style="background: #FAFAFA">
                ...
                <tr>
                  <td>
                    <textarea class="form-control" name="tf_post_meta" ></textarea>
                  </td>
                </tr>
              </table>
              <table class="table" style="background: #FAFAFA">
                ...
                <tr>
                  <td>
                    <div class="input-group mb-3">
                      <input type="text" class="form-control" placeholder="Example: Rank Math SEO" name="tf_post_key" >
                      <div class="input-group-append">
                        <button class="btn btn-danger" form="form_draft_blog" name="check" type="submit">Kiểm tra</button> 
                      </div>
                    </div>
                  </td>
                </tr>
    ...
    <div class="col-sm-3">
      ...
      <table class="table" style="background: #FAFAFA">
        ...
        <tr>
          <td style="background: white">
            <button type="button" class="btn btn-secondary">Lưu nháp</button><br><br>
            <li>Trạng thái: Bản nháp</li>
            <li>Hiển thị: Công khai</li>
          </td>
          <td style="background: white">
            <button type="button" style="float: right;" class="btn btn-secondary">Xem thử</button>
          </td>
        </tr>
        <tr>
          @if(isset($SEO))
        ...
        <tr>
          <td colspan="2">
            <li><button type="submit" form="form_draft_blog" name="tf_dangpost" style="float: right;" class="btn btn-info">Đăng</button></li>
          </td>
        </tr>
      </table>
    </div>
